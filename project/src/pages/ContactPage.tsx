  ...
  const faqs = [
    {
      ...
      answer: 'Simply find the book you want to review, click on it, and then click the "Write Review" button. You\'ll need to be signed in to submit reviews.',
    },
    {
      question: 'Can I edit my reviews?',
      answer: 'Currently, reviews cannot be edited after submission. However, you can delete and rewrite a review if needed.',
    },
    {
      question: 'How are book ratings calculated?',
      answer: 'Book ratings are calculated as the average of all user ratings for that book, updated in real-time as new reviews are submitted.',
    },
    {
      question: 'Is BookNest free to use?',
      answer: 'Yes! BookNest is completely free to use. You can browse books, read reviews, and write your own reviews without any cost.',
    },
  ];
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            ...
            <p className="text-xl text-gray-600 leading-relaxed max-w-3xl mx-auto">
              ...
              Our team is here to help make your BookNest experience amazing.
            </p>
          </motion.div>
        </div>
      </section>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-gray-600">
              Quick answers to common questions about BookNest.
            </p>
          </motion.div>
